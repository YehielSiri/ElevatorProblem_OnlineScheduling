...
public class Ex0_main {
    public static Long ID0=204155311L, ID1 = null, ID2 = null;
...
//        ElevatorAlgo ex0_alg = new Look(Simulator_A.getBuilding());    // Mine version of the LOOK scheduling algorithm;
